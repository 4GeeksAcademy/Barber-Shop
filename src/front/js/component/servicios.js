                ...
                <div className="serviciosColumn">
                    ...
                    <div className="row mb-5">
                        <div className="col-lg-3 col-md-6 col-12 text-end mb-3 mb-lg-0">
                            <img src="https://res.cloudinary.com/dc87bxiqf/image/upload/v1725551950/Adult_haircut_img_g7kfjw.png" className="img-fluid-servicios" alt="..." />
                        </div>
                        ...
                        <div className="col-lg-3 col-md-6 col-12 text-end mb-3 mb-lg-0">
                            <img src="https://res.cloudinary.com/dc87bxiqf/image/upload/v1725551950/Kids_haircut_img_g1ap6c.png" className="img-fluid-servicios" alt="..." />
                        </div>
                        <div className="col-lg-3 col-md-6 col-12 text-start">
                    ...
                    <div className="row mb-5">
                        <div className="col-lg-3 col-md-6 col-12 text-end mb-3 mb-lg-0">
                            <img src="https://res.cloudinary.com/dc87bxiqf/image/upload/v1725551950/Beard_trim_img_jnye2t.png" className="img-fluid-servicios" alt="..." />
                        </div>
                        <div className="col-lg-3 col-md-6 col-12 text-start">
                        ...
                        <div className="col-lg-3 col-md-6 col-12 text-end mb-3 mb-lg-0">
                            <img src="https://res.cloudinary.com/dc87bxiqf/image/upload/v1725551950/Barbershop_muuwo3.png" className="img-fluid-servicios" alt="..." />
                        </div>
                        <div className="col-lg-3 col-md-6 col-12 text-start">
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-6 col-12 text-end mb-3 mb-lg-0">
                            <img src="https://res.cloudinary.com/dc87bxiqf/image/upload/v1725551950/Scalp_moisturizing_img_vccebs.png" className="img-fluid-servicios" alt="..." />
                        </div>
                        <div className="col-lg-3 col-md-6 col-12 text-start">
                        ...
                        <div className="col-lg-3 col-md-6 col-12 text-end mb-3 mb-lg-0">
                            <img src="https://res.cloudinary.com/dc87bxiqf/image/upload/v1725551950/Barbershop_1_qqqku8.png" className="img-fluid-servicios" alt="..." />
                        </div>
                        <div className="col-lg-3 col-md-6 col-12 text-start">
