      ...
      <Row className="justify-content-center">
        <Col xs={12} md={8}>
          ...
          <div className="d-flex justify-content-between align-items-center mb-3">
            ...
            {/* Redirigir a /book-appointment-proffesional */}
            <Button
              variant="warning"
              size="lg"
              onClick={() => navigate('/book-appointment-proffesional')}
            >
              Book now
            </Button>
          </div>
          ...
          <p className="text-center">
            ...
            <span className="text-warning">★★★★★</span> (196) ·{' '}
            <span className="text-danger">Closed</span> opens soon at 9:00am · MG Road, Bangalore
          </p>
          ...
          <Row className="text-start mt-4">
            <Col xs={12} md={6}>
              <p>
                ...
                <br />
                4Geeks Academy España, dirección
              </p>
            </Col>
            <Col xs={12} md={6}>
              <p>
