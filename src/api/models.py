...
class Employee(db.Model):
    ...
    is_active = db.Column(Boolean, unique=False, nullable=False)
    admin_is_active = db.Column(Boolean, default=False, unique=False, nullable=True)
    salary = db.Column(Numeric(10, 2), unique=False, nullable=True)
    reservations_id = db.Column(db.Integer, unique=False, nullable=True)
    schedules_id = db.Column(db.Integer, unique=False, nullable=True)
